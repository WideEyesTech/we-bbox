...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bbox = function Bbox(options) {
	  ...
	  function _Bbox(_ref) {
	    ...
	    // EVENT LISTENERS
	    var md = _rx2.default.Observable.fromEvent(canvas, down).flatMap(_onMousedown).subscribe(_redrawCanvas);

	    var mu = _rx2.default.Observable.fromEvent(canvasContainer, up).flatMap(_onMouseup).subscribe(_styleCursor);
